...
forearm, arm, and dumbell of 5 participants.
...
We have Index in the first column and we have some user and time related data, which can be ignored for the data analysis. Hence I have removed those there.
```{r}
train_data$X <- NULL
```
